 /*
CSS template by 🥀 florcita 🥀 (#378453).
- This CSS is FREE USE if you follow my rules
- No reselling OR claiming my CSS as yours
- Do not remove my credit
- No sharing comissioned work before dm me first (just so i know they aren´t stealing it)
*/
...
body {
    background: url('https://get.wallhere.com/photo/temple-painting-arch-ruins-Greek-mythology-Frederic-Edwin-Church-The-Parthenon-ART-landmark-screenshot-ancient-history-ancient-greek-temple-ancient-roman-architecture-78006.jpg') center center fixed no-repeat;
    background-size: cover; /* Imagen centrada y ajustada en el fondo */
...
html:not(.nolayout) body:after {
    content: ''; /* El pseudo-elemento no tiene contenido */
    position: fixed; /* Fija la posición en la pantalla */
    top: -25px;
    left: -30px;
    width: 120%; /* Ocupa todo el ancho */
    height: 120%; /* Ocupa toda la altura */
    background: url('https://get.wallhere.com/photo/temple-painting-arch-ruins-Greek-mythology-Frederic-Edwin-Church-The-Parthenon-ART-landmark-screenshot-ancient-history-ancient-greek-temple-ancient-roman-architecture-78006.jpg') center center no-repeat; /* Imagen de fondo */
    background-size: cover!important; /* La imagen cubre toda la pantalla */
    z-index: -1; /* Coloca el pseudo-elemento detrás del contenido */
    pointer-events: none; /* Evita interacciones con el fondo */
}
...
body {
	background: url('https://i.pinimg.com/originals/55/d1/fc/55d1fcf2da6951bf7fe7c561a157024a.jpg') top center fixed;
   ...
   */ 
.breadcrumb::after {
    content: "CSS by florcita #378453";
	position: absolute;
    font-family: 'Cinzel', sans-serif;
    font-weight: bold;
    font-size: 10px;
    right: 15%;
    background-color: rgba(13, 86, 164, 0);
    text-shadow: 0px 0px 10px #6c4204;
    color: #fff;
    border-radius: 100px;
    pointer-events: none;
}
...
html::after {
    ...
    height: 300px;
    transform: scaleX(-1);
    background-image: url('https://sci-hub.se/pictures/alexandra/athena-big.png');
    background-repeat: no-repeat;
...
img[src$="logo-full-2.png"] {
    content: url('https://www.talos-rtd.com/wp-content/uploads/2022/10/Talos-%CE%9A%CF%81%CE%B1%CF%84%CE%AE%CF%81%CE%B1%CF%82.png');
    filter: drop-shadow(0px 0px 2px #ffd597);
    width:95px;
...
.navbar li a {
	color: #fff !important;
    text-shadow: 0px 0px 5px #ffd597 !important;
}

/* NAVBAR BUTTON HOVER */

.navbar li a:hover {
	background: #c19f6e !important;
	border: 3px double !important;
    border-color: #a1783b!important;
	color: #fff !important;
    text-shadow: 0px 0px 10px #ffd597 !important;
	border-radius: 15px;
    box-shadow: 0px 0px 10px #ffd597 !important;
    transition: 0.2s;
}
...
input.floatright, input.floatright:hover {
	background: #a1783bcc !important;
    border: none !important;
	border-radius: 0px;
    box-shadow: 0 0 5px #ffd597;
	color: #fff !important;   
}
...
/* free energy boost and others */
input,
select,
textarea {
	background: #63471d91 !important;
	border: none !important;
...
.alert-warning,
.alert-danger {
	background: #a1783b !important;
	border: 3px double !important;
    border-color: #6c4204!important;
	color: #fff;
    box-shadow: 0 0 5px #ffd597;
...
.panel {
	...
	background-image:url('https://64.media.tumblr.com/ffd9744478fe560c406aa8874c51bd81/7c4b9c00d420ad26-03/s1280x1920/a615f89105ade5a0732b65d4bbfae8da74ddcafb.jpg') !important;
	background-size: cover !important;
    background-position: top !important; 
    color: #fff !important;
	border: 0px ridge !important;
	border-radius: 10px;
	box-shadow: 0 0 5px #ffd597 !important;
}
...
.progress {
    ...
    box-shadow:  0px 0px 5px #6c4204!important;
    background: #63471dbd !important;
    background-position: top !important;
    background-size: 25%;
}
...
/* ENERGY BAR COLOR */
.progress-bar {
	background: linear-gradient(#c19f6ecc,#a1783bcc );
...
#fraSidebarChat iframe {
    z-index: 2; /* Asegúrate de que el iframe esté visible sobre el pseudo-elemento */
    background-color: #fff0 !important; /* Si el iframe debe tener un fondo propio */
}
...
.table {
    ...
    font-weight: bold;
	border-radius: 10px;
    text-shadow: 0 0 2px #6c4204;
    box-shadow:  0px 0px 10px #ffd597!important;
}

table#about {
    background: url('https://cdn.sanity.io/images/f23a1pgq/pma_production/767c1cc515ca8e372a7e7a69add499a5f31137b7-2300x1506.jpg?rect=0,166,2300,1174&bg=f2f2f2&w=1450&h=740&q=80&fit=clip') top no-repeat;
	background-size: cover;
    border: none !important;
    border-radius: 30px 30px 0px 0px;
    box-shadow:  0px 0px 5px #ffd597!important;
}
/*
table#player.table{
    background: url('https://media.istockphoto.com/id/1270418169/photo/natural-background-of-sandstoun-texture.jpg?s=612x612&w=0&k=20&c=iqiL1hT9sYPEtJcxAMx_fA7kVPyjEdGW-5M36eMd76M=')center;
    background-size: cover;
    background-repeat: no-repeat;
}
...
/* USE THESE TO CHANGE TO AN IMAGE */
...
.bottom,
th {
    /*background-image:url('https://i.pinimg.com/originals/c4/5f/5c/c45f5c008b4c67a03cfcf4e5282a91cd.gif')!important;*/
    background-color:rgba(166, 72, 72, 0)!important;
	color: #fff !important;
	border-radius: 30px 30px 0px 0px;
...
/* AMOUNT OF LIONS + VIEW ALL */

td.bottom a {
    text-decoration: none !important;
    background-color:rgba(72, 166, 83, 0)!important;
...
.inner-table .left {
	background: rgba(231, 16, 16, 0) !important;
    color: #fff;
	border-radius: 0px;
    text-shadow: 0 0 5px #000;
}
...
tr{
    background: rgba(173, 19, 19, 0) !important;
...
.item {
	background: rgba(242, 28, 28, 0) !important;
	border: none !important;
	border-radius: 0px !important
}
...
.innerbox {
    position: relative;
    top: -200px;
    background: rgba(255, 255, 255, 0.8); /* Color de fondo más claro para distinguir */
    color: #333; /* Color de texto */
    padding: 10px;
    height: 200px;
    width: 400px;
    border-radius: 10px;
    margin-top: -50px; /* Espacio entre la caja interna y el contenido de la caja principal */
    overflow: auto;
}
...
#lion_image:after {
    content:url("https://cdn.fastly.steamstatic.com/steamcommunity/public/images/items/701160/4b2e1b159a5daf94e7760f2d71f0a9d4f20a519c.png");
    position:absolute;
    width: 200% !important;
...
#player > tbody > tr.right > td:nth-child(2)::after {
    content:url('https://cdn.fastly.steamstatic.com/steamcommunity/public/images/items/1940340/9c17f7381c33a1ac99007100f7583e05267aefea.png');
    position:absolute;
    top:-20px;
    right: 10px;
    scale:.82;
...
div.cave-grid {
    position: relative; /* Añadido para posicionar el pseudo-elemento respecto al contenedor */
...
div.cave-grid > img {
    content: url('https://i.pinimg.com/736x/39/3f/32/393f32574c27d9a159a74cdcc27b0b9a.jpg') !important;
    width: 100%;
    height: 85%;
    border: 3px double !important;
    border-color: #6c4204!important;
...
div.cave-grid>img[src$="prideoverviewbanner.png"] {
	content: url('https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhpIY7GHf1zCvyGAVhWlCQgDsCGzzSA_i_Uwub4KL8jqE1PevzZ6urHyEkavJ4QOTWfmlLC5vB2tDPjm4fr3wCvQ_FVFMANkKVeBq9ljtCtE-65b2HPyHqEIUg4W-lV4MAweepmmMto-aspimq3pQUklupfNU1odFdymi6DdW9VtHBBRPgCOeoiRDa9Dw/s800/Paul%20Beckert,%20Leda%20and%20the%20Swan.jpg') !important;
}


div.cave-grid>img[src$="unsortedlionsbanner.png"] {
	content: url('https://static.wikia.nocookie.net/e8da29e8-c35e-4b83-9b13-1990a480aec8/scale-to-width/755') !important 
}

div.cave-grid>img[src$="nestingbanner.png"] {
	content: url('https://greekgodsparadise.com/wp-content/uploads/2017/09/Hercules-Room-Ceiling-Painting-France.jpg') !important;
}


a[href$="mound.php?PLAYER ID"]>div.mound-grid>img {
    content: url('https://64.media.tumblr.com/b85dcc04edc157d4f26e9c184a25a9bb/tumblr_p2k911tTO81x1kutmo1_540.gifv') !important;
    margin-left: -10px;
    margin-top: -100px;
    width: 250px;
    height: 125px;
...
.mound-grid {
    ...
    border-radius: 20px !important;
    box-shadow: 0px 0px 8px #fff0 !important;
}


.mound-grid img {
	background: url('https://img.pikbest.com/png-images/20240830/ancient-greek-bust-of-a-woman-with-blindfold-on-her-eyes-_10771971.png!sw800') center no-repeat;
	background-size:80%;
	width: 100%;
	height: 50%;
	padding-top: 70%;
	...
	border-radius: 10px !important;
	transition: 0.3s ease;
	box-shadow:  0px 0px 5px #4471ba00!important;

}

.mound-grid:hover img {
...
/* Start https://www.cursors-4u.com */ * {cursor: url(https://cur.cursors-4u.net/symbols/sym-1/sym34.cur), auto !important;} /* End https://www.cursors-4u.com */
